...
from app.Models.VoiceRecognationModel import VoiceRecognationModel
...
class MainController(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.answer = app.Models.DataModel.DataModel()  # класс для работы с данными от пользователя
